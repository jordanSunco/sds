package com.dawnwin.stick.utils;
...
public class JwtHelper {
    ...
    public static final String jwtId = "sticktokenId";
    /**
     * 创建JWT
     */
    public static String createJWT(String userName, Map<String, Object> claims, Long time) {
        ...
        JwtBuilder builder = Jwts.builder() //这里其实就是new一个JwtBuilder，设置jwt的body
                ...
                .setIssuedAt(now)
                .setSubject(userName)//iat: jwt的签发时间
    ...
    public static String generateToken(String username, Integer userId) {
        ...
        return createJWT(username, map, TOKEN_EXPIRED_TIME);
    }
}
